...
NK2Hardware.prototype.updateLEDtrack = function (ledOn)
{
	...
	host.getMidiOutPort (0).sendMidi (191, 34, 0);
	host.getMidiOutPort (0).sendMidi (191, 35, 0);
	host.getMidiOutPort (0).sendMidi (191, 36, 0);
	host.getMidiOutPort (0).sendMidi (191, 37, 0);
	host.getMidiOutPort (0).sendMidi (191, 38, 0);
	host.getMidiOutPort (0).sendMidi (191, 39, 0);

	host.getMidiOutPort (1).sendMidi (191, 32, 0);
	host.getMidiOutPort (1).sendMidi (191, 33, 0);
	host.getMidiOutPort (1).sendMidi (191, 34, 0);
	host.getMidiOutPort (1).sendMidi (191, 35, 0);
	host.getMidiOutPort (1).sendMidi (191, 36, 0);
	host.getMidiOutPort (1).sendMidi (191, 37, 0);
